...
/*
  ...
  async broadcastPaymentBatches()
  {
    ...
    var self = this ;
     ...
     setTimeout(function(){self.broadcastPaymentBatches()},2*60*1000)  //ten minutes......This will broad cast the multisend transaction in pool we are chnaging it to 2 minutes
